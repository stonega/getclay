		...
		<main className='mx-auto max-w-3xl px-4 py-12'>
			...
			<div className='space-y-8'>
				...
				<section>
					...
					<p className='leading-7 [&:not(:first-child)]:mt-6'>We use the information we collect to:</p>
					<ul className='list-disc pl-6 mt-4 space-y-2'>
				...
				<section>
					...
					<p className='leading-7 [&:not(:first-child)]:mt-6'>We use cookies and similar tracking technologies to:</p>
					<ul className='list-disc pl-6 mt-4 space-y-2'>
				...
				<section>
					...
					<p className='leading-7 [&:not(:first-child)]:mt-6'>
						...
						policy on this page and updating the effective date. Your continued use of our service after such
				...
				<section>
					...
					<p className='leading-7 [&:not(:first-child)]:mt-6'>
						If you have questions about this Privacy Policy or our practices, please contact us. We are committed to
